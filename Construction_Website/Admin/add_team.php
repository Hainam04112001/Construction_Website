...
<head>
  ...
  <title>Trang Quản Lý Website Xây Dựng | Add Team Member</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Thêm nhân viên thi công</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="" placeholder="Chức vụ" name="designation" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="short_detail" class="form-control"  placeholder="Mô tả ngắn" required></textarea>
                  </div>
                  <div class="form-group">
                    <label for="">Chi tiết</label>
                    <textarea name="detail" class="form-control"  placeholder="Mô tả" required></textarea>
                  </div>
                </div>
                <!-- /.card-body -->

                <div class="card-footer">
                  <button type="submit" class="btn btn-danger" name="add_team">Thêm nhân viên</button>
                </div>
              </form>
              <?php
