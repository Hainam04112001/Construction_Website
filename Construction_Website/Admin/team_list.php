...
<head>
  ...
  <title>HaiNam Construction | Team Member List</title>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Danh sách nhân viên <a href="add_team.php" class="btn btn-danger"><i class="fa fa-plus-circle"></i></a></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                          ...
                          while($project_data = mysqli_fetch_assoc($project_res)){
                            ...
                            ?>
                              <tr>
                                ...
                                <td>
                                        <img src="../teamImg/<?php echo $project_data['image'];?>" alt="<?php echo $project_data['image'];?>" style="width:50px; height:50px; margin:2px;">
                                </td>
                                <td><?php echo $project_data['less_details'];?></td>
                                <td style="width:30%"><?php echo $project_data['details'];?></td>
                                <td style="width:15%;">
                                  <a href="team_list.php?deleteId=<?php echo $project_data['id'];?>" onclick="return confirm('Bạn có thật sự muốn xóa ?');" class="btn btn-danger" title="Delete"><i class="fa fa-trash" aria-hidden="true" style="color:#ffffff; margin:2px;"></i></a>
