...
<head>
  ...
  <title>Trang Quản Lý Website Xây Dựng | Edit Social Media</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Cập nhật mạng xã hội</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="">Tên mạng xã hội</label>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-danger" name="update_social">Cập nhật</button>
                </div>
              </form>
              <?php
